...
*Full pipeline diagram lives in the flagship repo: [Solid-Electrolyte-MLIP-MD/figures/supplementary/08_pipeline_overview.png](https://github.com/E1582271-dotcom/Solid-Electrolyte-MLIP-MD/blob/main/figures/supplementary/08_pipeline_overview.png) (generated by [`08_pipeline_overview.py`](https://github.com/E1582271-dotcom/Solid-Electrolyte-MLIP-MD/blob/main/08_pipeline_overview.py)). This repo is **Project 3 (generate)** in that diagram — two of its S.U.N. leads (Li₃PS₄ gen016, LiPS₃ gen021) get MLIP-MD-validated in [Solid-Electrolyte-MLIP-MD](https://github.com/E1582271-dotcom/Solid-Electrolyte-MLIP-MD), including the ranking-reversal finding on LiPS₃.*
...
- ✅ **W11**: two leads (Li₃PS₄ gen016, LiPS₃ gen021) handed to Project 2 MLIP-MD for a real
  ...
  unified pipeline diagram drawn (`Solid-Electrolyte-MLIP-MD/figures/supplementary/08_pipeline_overview.png`, linked at
